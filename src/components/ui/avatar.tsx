...
>(({ className, ...props }, ref) => (
  <AvatarPrimitive.Root
    ref={ref}
    className={cn(
      "relative flex h-10 w-10 shrink-0 overflow-hidden rounded-full bg-gradient-to-br from-primary to-primary-foreground transition-all duration-300 ease-in-out will-change-transform",
      className,
    )}
    {...props}
  />
